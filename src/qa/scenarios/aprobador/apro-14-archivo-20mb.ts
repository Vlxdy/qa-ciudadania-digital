...
// Ajustar httpStatus según límite real del servidor (413 si hay límite de payload)
const EXPECTED = {
  success: false,
  httpStatus: 413,
};
...
export const scenario: Scenario = {
  ...META,
  description:
    'PDF de ~20 MB debe ser rechazado con 413 si supera el límite del servidor. ' +
