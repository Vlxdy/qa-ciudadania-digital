/**
 * comp-01 — Happy Path: comprobante de notificación a persona natural
 *
...
const META = {
  id: 'comp-01',
  name: 'Happy Path — comprobante de notificación natural',
  module: 'notificador' as const,
  tags: ['happy', 'comprobante'],
};
...
export const scenario: Scenario = {
  ...META,
  description: 'Consulta el comprobante de la notificación creada por noti-01. Retorna 201 con datos de registro y estado de lectura.',
