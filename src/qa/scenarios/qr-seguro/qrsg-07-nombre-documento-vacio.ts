/**
 * qrsg-07 — Validación Zod: nombreDocumento vacío
 */
...
const META = {
  id: 'qrsg-07',
  name: 'nombreDocumento vacío — qr-seguro',
...
const EXPECTED = {
  success: false,
  validationFields: ['documentoDigital.nombreDocumento'],
};

export const scenario: Scenario = {
  ...META,
  description: 'nombreDocumento vacío en documentoDigital debe fallar validación Zod.',
  run: async (): Promise<ScenarioResult> => {
    const base = await buildQrSeguroBody();
    const input = {
      ...base,
      documentoDigital: { ...base.documentoDigital, nombreDocumento: '' },
    };
